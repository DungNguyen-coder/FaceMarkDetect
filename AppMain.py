...
# 
    ...
    def DetectMask(self, frame):
        ...
        # mark is detected
                if(result == "Mask"):
                    ...
                    cv2.rectangle(frame, (x1, y1), (x2, y2), color, 2)
                    self.speak("Bạn chưa đeo khẩu trang, hãy chú ý đeo khẩu trang và sát khuẩn tay để bảo vệ bạn và mọi người xung quanh")
    ...
    def speak(self, text):
        ...
        r = re.patch("https://apps-mobile-5139c-default-rtdb.firebaseio.com/MedicalRobot/FaceMark.json", json= {"NoMark" : 1})

        nameImage = now.strftime("./images/NoMark/" +"%H_%M_%Sngay%dthang%m.jpg")
