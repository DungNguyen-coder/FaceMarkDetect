...
# 
    ...
    def DetectMask(self, frame):
        ...
        # mark is detected
                if(result == "Mask"):
                    ...
                    cv2.rectangle(frame, (x1, y1), (x2, y2), color, 2)
                    self.speak("Bạn chưa đeo khẩu trang, hãy chú ý đeo khẩu trang để bảo vệ bạn và mọi người xung quanh")
    ...
    def speak(self, text, mask = False):
        ...
        if(mask) :
            ...
            text = "Nhiệt độ cơ thể của bạn là " + str(tem_object) + " độ C, cửa đã được mở, chúc bạn một ngày làm việc thật hiệu quả"
